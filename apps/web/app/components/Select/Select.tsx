...
export const Select = forwardRef<HTMLSelectElement, SelectProps>(
	(props, ref) => {
		...
		return (
			<div
				className={`relative min-w-80 max-w-full ${SelectBlockSizeStyle[blockSize]}`}
			>
				<select
					className={`
        ...
        `}
					onMouseDown={
						props["aria-disabled"] ? handleDisabledMouseDown : onMouseDown
					}
