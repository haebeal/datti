...
func (w *ServerInterfaceWrapper) LendingDelete(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "lendingId", ctx.Param("lendingId"), &lendingId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
// UserUpdateMe converts echo context to params.
func (w *ServerInterfaceWrapper) UserUpdateMe(ctx echo.Context) error {
	var err error

	ctx.Set(BearerAuthScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.UserUpdateMe(ctx)
	return err
}
...
func (w *ServerInterfaceWrapper) UserUnlinkLINE(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.UserUnlinkLINE(ctx)
	return err
}

// UserLinkLINE converts echo context to params.
func (w *ServerInterfaceWrapper) UserLinkLINE(ctx echo.Context) error {
	var err error

	ctx.Set(BearerAuthScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.UserLinkLINE(ctx)
	return err
}
