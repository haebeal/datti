...
type ServerInterface interface {
	...
	BorrowingGetAll(ctx echo.Context, id string, params BorrowingGetAllParams) error
	// グループ内の借り取得
...
func (w *ServerInterfaceWrapper) BorrowingGetAll(ctx echo.Context) error {
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params BorrowingGetAllParams
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.BorrowingGetAll(ctx, id, params)
	return err
}
