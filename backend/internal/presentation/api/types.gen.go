...
// BorrowingPaginatedResponse defines model for Borrowing.PaginatedResponse.
type BorrowingPaginatedResponse struct {
	Borrowings []BorrowingGetAllResponse `json:"borrowings"`
...
// BorrowingGetAllParams defines parameters for BorrowingGetAll.
type BorrowingGetAllParams struct {
