/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 06bcafb5887acd689e3d2df7f4bb354d)
// Runtime types generated with workerd@1.20250816.0 2025-05-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DSN: string;
		BACKEND_CONTAINER: DurableObjectNamespace<import("./index").BackendContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DSN">> {}
}
